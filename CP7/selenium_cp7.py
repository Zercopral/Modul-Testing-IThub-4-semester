...
# Только данный тест является рабочим. На остальных не изменены css-selector
...
def test_product_screens(driver):
    MainPage(driver).click_featured_product(1)
...
# # На сайте https://demo-opencart.ru/index.php?route=common/home
# # Отсутсвует возможность мены валют
# # Тест исключен
# @allure.feature("Menu")
