...
class MainPage(BasePage):
    ...
    # Второй тест исключен, так как нет функционала смены валют
    ...
    PRODUCT_LINK = (By.CSS_SELECTOR, ".caption > h4 > a")
    ...
    OPEN_MENU = (By.CSS_SELECTOR, ".navbar-nav > li")
    LINKS_OPENED_MENU = (By.CSS_SELECTOR, "div.dropdown-menu > div > ul > li")
